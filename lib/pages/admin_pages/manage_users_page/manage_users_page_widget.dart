...
class ManageUsersPageWidget extends StatefulWidget {
  const ManageUsersPageWidget({Key? key}) : super(key: key);

  @override
  _ManageUsersPageWidgetState createState() => _ManageUsersPageWidgetState();
}
...
class _ManageUsersPageWidgetState extends State<ManageUsersPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ManageUsersPage'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('MANAGE_USERS_arrow_back_ios_rounded_ICN_');
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'MANAGE_USERS_Icon_fpbehji5_ON_TAP');
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'Um email foi enviado ao usuário para atualização dos dados cadastrais.'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MANAGE_USERS_Icon_s4gck7g0_ON_TAP');
                                        logFirebaseEvent('Icon_alert_dialog');
